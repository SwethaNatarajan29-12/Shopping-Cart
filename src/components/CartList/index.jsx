      ...
      <div className="grid md:grid-cols-3 gap-8 mt-12">
        ...
        <div className="bg-gray-100 rounded-sm p-4 h-max">
          ...
          <div className="mt-5 flex gap-2">
            <button className=" disabled:opacity-55 cursor-pointer text-sm px-4 py-3 bg-black text-white font-extrabold rounded-lg" disabled = {cartItems.length == 0}>
              Checkout
            </button>
            <button
              onClick={() => navigate("/product-list")}
              className="cursor-pointer text-sm px-4 py-3 bg-black text-white font-extrabold rounded-lg"
            >
              Continue Shopping
            </button>
          </div>
